...
class Price_Performance_Asessments(unittest.TestCase):
    ...
    def test_a_goods_services_asessments_add_goods(self):
        ...
        time.sleep(2)
        driver.find_element(By.XPATH,"//*[@id='list_po_details']/tr/td[1]/input").click()
        time.sleep(1)
        driver.find_element(By.XPATH,"//*[@id='tabs-emp-1']/div/button").click()
        time.sleep(2)
        ...
        driver.find_element(By.XPATH,"//*[@id='tabs-emp-2']/div[3]/button").click()
        time.sleep(3)
